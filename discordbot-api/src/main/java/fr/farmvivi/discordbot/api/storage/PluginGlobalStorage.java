...
/**
 * Plugin-specific global storage context.
 */
public class PluginGlobalStorage {
    private final GlobalStorage storage;
    private final String namespace;

    public PluginGlobalStorage(GlobalStorage storage, String namespace) {
    ...
    /**
     * Gets all keys in global storage for this plugin.
     *
    ...
    /**
     * Gets all values in global storage for this plugin.
     *
    ...
    /**
     * Clears all global storage data for this plugin.
     *
     * @return true if successful
     */
