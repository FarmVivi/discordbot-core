...
import fr.farmvivi.discordbot.api.command.PluginCommandAdapter;
...
import fr.farmvivi.discordbot.api.language.PluginLanguageAdapter;
import fr.farmvivi.discordbot.api.permissions.PermissionManager;
import fr.farmvivi.discordbot.api.permissions.PluginPermissionAdapter;
import fr.farmvivi.discordbot.api.storage.DataStorageManager;
import fr.farmvivi.discordbot.api.storage.PluginDataStorageAdapter;
import fr.farmvivi.discordbot.api.storage.binary.BinaryStorageManager;
import fr.farmvivi.discordbot.api.storage.binary.PluginBinaryStorageAdapter;
