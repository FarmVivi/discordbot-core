...
/**
 * Plugin-specific user binary storage context.
 */
public class PluginUserBinaryStorage {
    private final UserBinaryStorage storage;
    private final String namespace;

    public PluginUserBinaryStorage(UserBinaryStorage storage, String namespace) {
