...
/**
 * Plugin-specific user-guild binary storage context.
 */
public class PluginUserGuildBinaryStorage {
    private final UserGuildBinaryStorage storage;
    private final String namespace;

    public PluginUserGuildBinaryStorage(UserGuildBinaryStorage storage, String namespace) {
