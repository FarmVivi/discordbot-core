...
/**
 * Plugin-specific global binary storage context.
 */
public class PluginGlobalBinaryStorage {
    private final GlobalBinaryStorage storage;
    private final String namespace;

    public PluginGlobalBinaryStorage(GlobalBinaryStorage storage, String namespace) {
