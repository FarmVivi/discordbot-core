package fr.farmvivi.discordbot.api.storage;
...
/**
 * Plugin-specific user-guild storage context.
 */
public class PluginUserGuildStorage {
    private final UserGuildStorage storage;
    private final String namespace;

    public PluginUserGuildStorage(UserGuildStorage storage, String namespace) {
    ...
    /**
     * Gets all keys in user-guild storage for this plugin.
     *
    ...
    /**
     * Gets all values in user-guild storage for this plugin.
     *
    ...
    /**
     * Clears all user-guild storage data for this plugin.
     *
     * @return true if successful
     */
