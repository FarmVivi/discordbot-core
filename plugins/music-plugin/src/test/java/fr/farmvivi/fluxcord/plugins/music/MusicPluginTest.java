...
public class MusicPluginTest {
    ...
    @Mock
    private PluginPermissionAdapter permissionAdapter;
    ...
    void setUp() {
        ...
        when(context.getDataStorage()).thenReturn(dataStorage);
        when(context.getLanguageAdapter()).thenReturn(languageAdapter);
        when(context.getPermissionManager()).thenReturn(permissionAdapter);
    ...
    void testPluginInitialization() {
        ...
        verify(permissionAdapter, atLeast(6)).registerPermission(any());
