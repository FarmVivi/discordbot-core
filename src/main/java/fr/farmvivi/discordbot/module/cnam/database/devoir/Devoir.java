...
public class Devoir {
    ...
    public Devoir(LocalDate datePour, String description, Integer idEnseignant, String codeEnseignement, Integer idCoursDonne) {
        this(datePour, description, null, idEnseignant, codeEnseignement, null, idCoursDonne);
    }

    public Devoir(LocalDate datePour, String description, Long discordMessageId, Integer idEnseignant, String codeEnseignement, Integer idCoursPour, Integer idCoursDonne) {
        this(-1, datePour, description, discordMessageId, idEnseignant, codeEnseignement, idCoursPour, idCoursDonne);
    }

    public Devoir(int id, LocalDate datePour, String description, Long discordMessageId, Integer idEnseignant, String codeEnseignement, Integer idCoursPour, Integer idCoursDonne) {
        this.id = id;
